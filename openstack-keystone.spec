...
PYTHONPATH=. oslo-config-generator --namespace %{service} --formal yaml > %{service}-schema.yaml
PYTHONPATH=. oslo-config-generator --namespace %{service} --formal json > %{service}-schema.json
