...
PYTHONPATH=. oslo-config-generator --namespace keystone --formal yaml > keystone-schema.yaml
PYTHONPATH=. oslo-config-generator --namespace keystone --formal json > keystone-schema.json
...
install -p -D -m 640 keystone-schema.yaml %{buildroot}%{_sysconfdir}/keystone/keystone-schema.yaml
install -p -D -m 640 keystone-schema.json %{buildroot}%{_sysconfdir}/keystone/keystone-schema.json
...
%config(noreplace) %attr(0640, root, keystone) %{_sysconfdir}/keystone/keystone-schema.yaml
%config(noreplace) %attr(0640, root, keystone) %{_sysconfdir}/keystone/keystone-schema.json
