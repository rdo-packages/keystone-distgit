...
%changelog
* Wed Apr 03 2024 RDO <dev@lists.rdoproject.org> 1:25.0.0-1
- Update to 25.0.0

* Tue Mar 19 2024 RDO <dev@lists.rdoproject.org> 1:25.0.0-0.1.0rc1
- Update to 25.0.0.0rc1


# REMOVEME: error caused by commit https://opendev.org/openstack/keystone/commit/2d47a47cb42a4e3a0e5f691fcd029d084b7614e9
