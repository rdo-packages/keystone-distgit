...
PYTHONPATH=. oslo-config-generator --namespace %{service} --format yaml > %{service}-schema.yaml
PYTHONPATH=. oslo-config-generator --namespace %{service} --format json > %{service}-schema.json
